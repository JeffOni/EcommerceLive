...
<x-container class="py-8">
    <div class="mx-auto max-w-7xl">
        ...
        <div class="grid items-start grid-cols-1 gap-12 lg:grid-cols-2"> {{-- 
            ...
            --}}
            <div class="space-y-6"> {{-- 
                    IMAGEN PRINCIPAL CON OVERLAYS
                    ============================
                    - Imagen principal del producto con placeholder local
                ...
                <div class="relative group">
                    ...
                    ====================
                    - Scroll horizontal para múltiples imágenes
                    - Imagen principal como primer thumbnail
                    - Support para galería adicional del producto
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex space-x-3 overflow-x-auto pb-2">
                        ...
                        <div class="flex-shrink-0">
                            <button
                                class="relative w-20 h-20 overflow-hidden border-2 border-blue-500 ring-2 ring-blue-200 rounded-xl transition-all duration-200">
                                <img src="{{ $product->image }}" alt="Vista principal"
                        ...
                        @if ($product->gallery && count($product->gallery) > 1)
                            @foreach (array_slice($product->gallery, 1) as $index => $image)
                                <div class="flex-shrink-0">
                                    <button
                                        class="relative w-20 h-20 overflow-hidden border-2 border-gray-200 opacity-70 hover:opacity-100 hover:border-gray-300 rounded-xl transition-all duration-200">
            ...
            <div class="space-y-8"> {{-- 
                ...
                <div class="space-y-3">
                    ...
                    DESCRIPCIÓN DEL PRODUCTO
                    ========================
                    Sección informativa con descripción detallada
                --}}
                <div class="space-y-3">
