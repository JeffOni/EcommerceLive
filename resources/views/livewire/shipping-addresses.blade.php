...
<div class="relative overflow-hidden rounded-lg bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-100">
    ...
    <div class="relative px-2 py-4 mx-auto xs:px-4 xs:py-6 sm:py-8 max-w-7xl sm:px-6 lg:px-8">
        ...
        {{-- Contenedor principal con glassmorphism responsive --}}
        <div
            ...
            <div class="p-3 xs:p-6 sm:p-8">
                {{-- Mensajes de estado con diseño mejorado --}}
                @if (session()->has('message'))
                <div class="p-4 mb-6 border shadow-lg glass-effect bg-emerald-50/80 border-emerald-200/50 rounded-2xl">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
                            ...
                            <div>
                                ...
                                <select wire:model.live="createAddress.parish_id"
                                    ...
                                    <option value="">
                                        {{ empty($parishes) ? 'Primero selecciona un cantón' : 'Selecciona una
                                        parroquia' }}
                                    </option>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <input wire:model="createAddress.receiver_document_number" type="text"
                                    ...
                                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                        ...
                                        <div>
                                            <label class="block mb-1 text-sm font-medium text-gray-700">Número
                                                de
                                                documento</label>
                                            <input wire:model="editAddress.receiver_document_number" type="text"
                                                placeholder="Ej: 1234567890"
                                                class="w-full border-gray-300 rounded-lg shadow-sm focus:border-amber-500 focus:ring-amber-500">
                                        ...
                                        <div>
                                            <label class="block mb-1 text-sm font-medium text-gray-700">Teléfono
                                                *</label>
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    {{-- Botón de eliminar --}}
                                    <button onclick="confirmDelete({{ $address->id }})" title="Eliminar dirección"
                        ...
                        <div class="p-3">
                            <div class="space-y-1.5">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-xs text-gray-600">{{ $address->postal_code }}</span>
                                </div>
                                @endif
                                ...
                                <div class="flex items-start space-x-2">
                                    ...
                                    <span class="text-xs text-gray-600 truncate">{{ $address->reference }}</span>
                                </div>
                                @endif
                                ...
                                <div
                                    ...
                                    <div class="flex items-center mb-1 space-x-1">
                                        ...
                                        <span class="text-xs font-medium text-amber-900">Receptor:</span>
                                        <span class="text-xs truncate text-amber-800">{{ trim(($receiverInfo['name'] ??
                                            '') . ' ' . ($receiverInfo['last_name'] ?? '')) ?: 'N/A' }}</span>
                                    </div>
                                    @if (!empty($receiverInfo['phone']))
                                    <div class="flex items-center space-x-1">
                                        <i class="text-xs fas fa-phone text-amber-500"></i>
                                        <span class="text-xs truncate text-amber-800">{{ $receiverInfo['phone']
                                            }}</span>
                                    </div>
                                    @endif
                                </div>
