    ...
    <form wire:submit.prvent="store">
        ...
        <figure class="relative mb-4">
            ...
            <img class="aspect-[16/9] object-cover w-full  object-center"
                src="{{ $image ? $image->temporaryUrl() : asset('/img/no-image.png') }}" alt="Imagen de Productos">
        ...
        <div class="p-6 bg-white rounded-lg shadow-lg">
            ...
            <div class="mb-4">
                ...
                <x-input class="w-full" type="text" wire:model.defer="product.sku"
                    placeholder="Código del Producto" />
            </div>
            <div class="mb-4">
                <x-label class="mb-2" value="{{ __('Nombre') }}" />
                <x-input class="w-full" type="text" wire:model.defer="product.name"
                    placeholder="Nombre del Producto" />
            </div>
            <div class="mb-4">
                <x-label class="mb-2" value="{{ __('Descripción') }}" />
                <x-textarea class="w-full" wire:model.defer="product.description" placeholder="Descripción del Producto"
                    rows="5" />
            </div>
            <div class="mb-4">
                <x-label class="mb-2" value="{{ __('Precio') }}" />
                <x-input class="w-full" type="number" step="0.01" wire:model.defer="product.price"
            ...
            <div class="mb-4">
                ...
                <x-select wire:model.live="product.subcategory_id" class="w-full" name="subcategory_id"
                    id="subcategory_id">
                    {{-- wire:model.live el .live sirve para que se vaya acutalizando el estdo del category_id conforme se vaya escribiendo --}}
