<div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
    ...
    <div class="text-center mb-8 pt-8">
        <h1
            class="text-4xl font-bold bg-gradient-to-r from-primary-900 to-secondary-500 bg-clip-text text-transparent mb-2">
            Gestión de Opciones
        </h1>
        <p class="text-secondary-600 text-lg">Administra las opciones y características de tus productos</p>
    </div>
        ...
        <header class="relative mb-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="flex items-center space-x-3">
                    <div
                        class="w-12 h-12 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-xl flex items-center justify-center shadow-lg">
                        <i class="fas fa-cogs text-white text-xl"></i>
                    </div>
                    <div>
                        <h2 class="text-2xl font-bold text-primary-800">Opciones Disponibles</h2>
                        <p class="text-secondary-600">Configura las opciones para tus productos</p>
                    </div>
                </div>
                <button wire:click="$set('newOption.openModal', true)" type="button"
                    class="px-6 py-3 bg-gradient-to-r from-primary-900 to-secondary-500 hover:from-primary-800 hover:to-secondary-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center space-x-2">
                    ...
                    <div class="relative p-8">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-2 mb-4">
                                <div class="h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent flex-1">
                                </div>
                                <span
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                <div class="group/feature relative">
                                    <div
                                        ...
                                        <span class="text-sm font-medium text-gray-700">{{ $feature->description
                                            }}</span>
                                        <button onclick="confirmDelete({{ $feature->id }}, 'feature')"
                                            class="p-1 rounded-full bg-red-100 hover:bg-red-200 transition-all duration-200 transform hover:scale-110 opacity-70 group-hover/feature:opacity-100">
                                            <i class="fas fa-xmark text-red-500 text-xs"></i>
                            ...
                            <div class="mt-6 pt-4 border-t border-gray-200">
                                @livewire('admin.options.add-new-feature', ['option' => $option], key('add-new-feature-'
                                . $option->id))
                            </div>
                        </div>
                    </div>
