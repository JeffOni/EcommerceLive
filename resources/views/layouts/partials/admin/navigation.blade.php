        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex ms-2 md:me-24">
                    <img src="{{ asset('img/logo.png') }}" class="h-8 me-3" alt="LagoFish Logo" />
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-primary-800 dark:text-white">LagoFish
                        Admin</span>
                </a>
            </div>
