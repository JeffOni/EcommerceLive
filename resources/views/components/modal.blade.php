...
<div x-data="{ show: @entangle($attributes->wire('model')) }" x-on:close.stop="show = false"
    ...
    class="fixed inset-0 z-50 px-2 sm:px-4 py-3 sm:py-5 overflow-y-auto jetstream-modal" style="display: none;">
    ...
    <div x-show="show"
        class="mb-4 bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl overflow-hidden shadow-lg transform transition-all w-full {{ $maxWidth }} mx-auto max-h-full"
