                ...
                <li class="breadcrumb-item">
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('families.show', $subcategory->category->family->id) }}"
                            ...
                            <span class="truncate">{{ Str::limit($subcategory->category->family->name, 12) }}</span>
                        </a>
                    </div>
                </li>
                <li class="breadcrumb-item">
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('categories.show', $subcategory->category) }}"
                            ...
                            <span class="truncate">{{ Str::limit($subcategory->category->name, 12) }}</span>
                        </a>
                    </div>
                </li>
                <li aria-current="page" class="breadcrumb-item">
                    <div class="flex items-center">
                        ...
                        <span
                            ...
                            <i class="fas fa-tags mr-1 text-xs flex-shrink-0"></i>
