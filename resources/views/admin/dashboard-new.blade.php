                        ...
                        <div>
                            ...
                            <div class="flex items-center mt-1">
                                <span class="text-sm text-gray-500">Hoy:
                                    {{ \App\Models\Order::whereDate('created_at', today())->count() }}</span>
                            </div>
                        </div>
                ...
                <div class="p-6 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900">
                                {{ \App\Models\User::whereHas('orders')->count() }}</p>
                            <div class="flex items-center mt-1">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <a href="{{ route('admin.payments.verification') }}"
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-xs text-gray-500">
                                    {{ \App\Models\Payment::where('status', 'pending')->count() }} pendientes</p>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('admin.orders.verified') }}"
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-xs text-gray-500">{{ \App\Models\Order::where('status', 2)->count() }}
                                    listas</p>
                            </div>
                        </a>
