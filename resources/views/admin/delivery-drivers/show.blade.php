                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 text-center">
                            ...
                            <p class="text-muted">
                                {{ $deliveryDriver->vehicle_type ? ucfirst(str_replace('_', ' ', $deliveryDriver->vehicle_type)) : 'Sin vehículo asignado' }}
                            </p>
                        </div>
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <table class="table table-sm">
                                        <tr>
                                            ...
                                            <td>{{ $deliveryDriver->vehicle_type ? ucfirst(str_replace('_', ' ', $deliveryDriver->vehicle_type)) : 'No especificado' }}
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <tbody>
                                    @foreach ($deliveryDriver->shipments->take(10) as $shipment)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-{{ $shipment->status == 'pending'
                                                        ? 'warning'
