            ...
            <div class="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div class="flex space-x-2">
                    <a href="{{ route('admin.subcategories.edit', $subcategory) }}"
                        class="p-2 glass-effect rounded-lg shadow-md hover:bg-pink-500 hover:text-white transition-all duration-200">
                ...
                <div class="text-center flex-1">
                    ...
                    <div class="space-y-2 mb-4">
                        <div class="flex items-center justify-center space-x-2 text-xs">
                            <span class="bg-primary-100 text-primary-700 px-2 py-1 rounded-md">
                        ...
                        <div class="flex items-center justify-center space-x-2 text-xs">
                            <span class="bg-secondary-100 text-secondary-700 px-2 py-1 rounded-md">
                    ...
                    <div class="space-y-2 text-sm text-gray-600">
                        <div class="flex items-center justify-center space-x-2">
                            <i class="fas fa-box text-secondary-500"></i>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-secondary-50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <span
                                    ...
                                    <i class="fas fa-box mr-2 text-secondary-500"></i>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                            @if ($subcategory->created_at)
                            <div class="flex items-center">
                                <i class="fas fa-calendar-plus text-secondary-500 mr-2"></i>
                                {{ $subcategory->created_at->format('d/m/Y') }}
                                <span class="block text-xs text-gray-400">{{ $subcategory->created_at->diffForHumans()
                                    }}</span>
                            </div>
                            @endif
                        </td>
