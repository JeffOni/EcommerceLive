                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-orange-100 text-sm">Administra las portadas del sitio web con función de
                            ...
                            @foreach ($covers as $cover)
                                <li class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 cursor-move overflow-hidden border border-gray-100"
                                    ...
                                    <div class="lg:flex">
                                        ...
                                        <div class="flex-1 p-6 lg:p-8">
                                            <div
                                                ...
                                                <div
                                                    class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:flex-1 lg:max-w-lg">
                                                    <div
                                                    ...
                                                    <div
                                                        ...
                                                        <p class="text-sm text-red-600 font-medium">
                                                            {{ $cover->end_at ? $cover->end_at->format('d/m/Y') : 'Sin fecha límite' }}
                                                        </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lg:flex-shrink-0">
                                                    <a href="{{ route('admin.covers.edit', $cover) }}"
                                                        class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                                    ...
                                    <div
                                        ...
                                        <div
                                            class="bg-orange-100 text-orange-600 px-3 py-1 rounded-lg text-xs font-medium">
                    ...
                    @else
                        ...
                        <div class="text-center py-16">
                            <div
                                ...
                                <i class="fas fa-image text-4xl text-orange-500"></i>
                            </div>
                            ...
                            <a href="{{ route('admin.covers.create') }}"
                                class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
