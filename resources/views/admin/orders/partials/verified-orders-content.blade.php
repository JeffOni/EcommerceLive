            ...
            @foreach ($orders as $order)
                <div class="order-card p-6 rounded-xl">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <span
                            class="payment-method-badge {{ $order->payment_method == 0
                    ...
                    <div class="flex flex-wrap gap-2">
                        @if ($order->status == 2)
                            ...
                            <button onclick="updateOrderStatus({{ $order->id }}, 3)"
                                class="action-btn btn-prepare flex-1">
                                <i class="fas fa-cogs mr-1"></i> Preparar
                            </button>
                            <button onclick="updateOrderStatus({{ $order->id }}, 4)"
                                class="action-btn btn-ready flex-1">
                        ...
                        @elseif($order->status == 4)
                            ...
                            @if (!$order->hasShipment())
                                <button onclick="createShipment({{ $order->id }})"
                                    class="action-btn btn-ship flex-1">
