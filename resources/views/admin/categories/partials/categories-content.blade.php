...
- Se removieron los botones de edición que aparec <i class="fas fa-layer-group mr-2 text-primary-500"></i>an al hacer
            ...
            <div class="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div class="flex space-x-2">
                    <a href="{{ route('admin.categories.edit', $category) }}"
                        class="p-2 glass-effect rounded-lg shadow-md hover:bg-teal-500 hover:text-white transition-all duration-200">
            ...
            <div class="p-6 pt-16 flex-1 flex flex-col">
                <div class="text-center flex-1">
                    ...
                    <div class="space-y-2 text-sm text-gray-600">
                        ...
                        <div class="flex items-center justify-center space-x-2">
                            <i class="fas fa-calendar-plus text-primary-500"></i>
                    ...
                    <tr class="hover:bg-secondary-50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="block text-xs text-gray-400">{{ $category->created_at->diffForHumans()
                                    }}</span>
                            </div>
                            @endif
                        </td>
