    ...
    <div class="min-h-screen bg-gradient-to-br from-secondary-50 via-white to-primary-50">
        <div class="relative">
            ...
            <div class="text-center mb-4 sm:mb-6 pt-4 sm:pt-6 px-3 sm:px-4">
                ...
                <p class="text-xs sm:text-sm text-secondary-600">Administra las categorías organizadas por familias</p>
            </div>
            ...
            <div
                    ...
                    <div class="flex flex-col space-y-3 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                        <div class="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
                            <div
                                ...
                                <i class="text-sm sm:text-base lg:text-xl text-white fas fa-tags"></i>
                            </div>
                            <div class="min-w-0 flex-1">
                                <h2 class="text-sm sm:text-lg lg:text-2xl font-bold text-white truncate">Categorías</h2>
                                <p class="text-xs sm:text-sm text-secondary-100 truncate">Organizada por familias</p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col space-y-2 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4">
                            <div class="relative flex-1 sm:flex-none">
                                <input type="text" id="search-input" placeholder="Buscar..."
                                    ...
                                    class="w-full sm:w-48 lg:w-64 py-1.5 sm:py-2 pl-8 sm:pl-10 pr-3 sm:pr-4 text-xs sm:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary-500 focus:border-secondary-500">
                                <i
                                    class="absolute text-gray-400 fas fa-search left-2.5 sm:left-3 top-2 sm:top-3 text-xs sm:text-sm"></i>
                            </div>
                            <select id="items-per-page"
                                class="px-2 py-1.5 sm:px-3 sm:py-2 text-xs sm:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary-500">
                ...
                <div class="p-3 sm:p-5 lg:p-8" id="categories-container">
                    @if ($categories->count())
                    ...
                    <div class="py-8 sm:py-12 lg:py-16 text-center">
                        ...
                        <a href="{{ route('admin.categories.create') }}"
                            ...
                            <span class="text-white text-sm sm:text-base">Crear Primera Categoría</span>
                        </a>
                    </div>
                    @endif
                </div>
