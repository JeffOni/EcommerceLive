<x-admin-layout :breadcrumbs="[
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-secondary-50">
        ...
        <div class="text-center mb-4 sm:mb-6 lg:mb-8 pt-4 sm:pt-6 lg:pt-8 px-3 sm:px-4">
            ...
            <p class="text-xs sm:text-base lg:text-lg text-gray-600">Modifica la información de la categoría "{{
                $category->name }}"</p>
        </div>
                    ...
                    <form action="{{ route('admin.categories.update', $category) }}" method="POST"
                        ...
                        <div class="flex items-center space-x-2 sm:space-x-3 lg:space-x-4 mb-4 sm:mb-6 lg:mb-8">
                            ...
                            <div class="min-w-0 flex-1">
                                <h2 class="text-sm sm:text-lg lg:text-2xl font-bold text-gray-800 truncate">Información
                                    de la Categoría</h2>
                                <p class="text-xs sm:text-sm lg:text-base text-gray-600 truncate">Actualiza los datos de
                                    la categoría</p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="space-y-2 sm:space-y-3 lg:space-y-4">
                                ...
                                <x-select name="family_id" id="family_id"
                                    ...
                                    <option value="{{ $family->id }}" @selected(old('family_id', $category->family_id)
                                        == $family->id)>
                                        {{ $family->name }}
                                    </option>
                                    @endforeach
