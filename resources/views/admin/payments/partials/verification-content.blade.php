            ...
            <div>
                ...
                <div class="text-center my-4">
                    ...
                    <div class="flex flex-col items-center justify-center cursor-pointer"
                        ...
                        <div
                            class="flex items-center justify-center w-24 h-24 bg-red-50 rounded-lg border border-gray-200 hover:scale-105 transition-transform">
                            <i class="fas fa-file-pdf text-5xl text-red-500"></i>
                        </div>
                        <p class="text-xs text-gray-500 mt-2">Archivo PDF - Click para ver</p>
                    </div>
                    @else
