<x-app-layout>
    ...
    <div class="relative h-[500px] lg:h-[600px] bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700">
        ...
        <div class="relative flex items-end justify-center h-full pb-20">
            <div class="flex flex-col gap-4 sm:flex-row">
                <a href="{{ route('products.index') }}"
                    class="inline-flex items-center px-8 py-4 font-semibold text-purple-600 transition duration-300 bg-white shadow-xl rounded-xl hover:bg-gray-100">
                    <i class="mr-2 fas fa-shopping-bag"></i>Explorar Catálogo
                </a>
                @guest
                <a href="{{ route('register') }}"
                    class="inline-flex items-center px-8 py-4 font-semibold text-white transition duration-300 border-2 border-white rounded-xl hover:bg-white hover:text-purple-600">
                    <i class="mr-2 fas fa-user-plus"></i>Crear Cuenta
                </a>
                @endguest
            </div>
    ...
    <div class="py-20 bg-gray-50">
        <x-container>
            <div class="mb-16 text-center">
                <h2 class="mb-6 text-4xl font-bold text-gray-800">¿Por qué elegirnos?</h2>
                <p class="max-w-3xl mx-auto text-xl text-gray-600">Ofrecemos la mejor experiencia de compra online con
                    servicios
                    de calidad que garantizan tu satisfacción</p>
            </div>
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                <div
                    class="p-10 text-center transition-all duration-300 bg-white border border-gray-100 shadow-lg feature-card group rounded-2xl hover:shadow-2xl">
                    <div
                        class="flex items-center justify-center w-20 h-20 mx-auto mb-6 transition-transform duration-300 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl group-hover:scale-110">
                        <i class="text-3xl text-white fas fa-shipping-fast"></i>
                    </div>
                    <h3 class="mb-4 text-2xl font-bold text-gray-800">Envío Rápido</h3>
                    <p class="leading-relaxed text-gray-600">Entrega express en 24-48 horas con seguimiento en tiempo
                        real de tu pedido desde el momento de la compra.</p>
                </div>
                <div
                    class="p-10 text-center transition-all duration-300 bg-white border border-gray-100 shadow-lg feature-card group rounded-2xl hover:shadow-2xl">
                    <div
                        class="flex items-center justify-center w-20 h-20 mx-auto mb-6 transition-transform duration-300 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl group-hover:scale-110">
                        <i class="text-3xl text-white fas fa-shield-alt"></i>
                    </div>
                    <h3 class="mb-4 text-2xl font-bold text-gray-800">Compra Segura</h3>
                    <p class="leading-relaxed text-gray-600">Transacciones 100% protegidas con encriptación SSL y
                        múltiples métodos de pago disponibles.</p>
                </div>
                <div
                    class="p-10 text-center transition-all duration-300 bg-white border border-gray-100 shadow-lg feature-card group rounded-2xl hover:shadow-2xl">
                    <div
                        class="flex items-center justify-center w-20 h-20 mx-auto mb-6 transition-transform duration-300 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl group-hover:scale-110">
                        <i class="text-3xl text-white fas fa-headset"></i>
                    </div>
                    <h3 class="mb-4 text-2xl font-bold text-gray-800">Soporte 24/7</h3>
                    <p class="leading-relaxed text-gray-600">Atención al cliente profesional disponible las 24 horas
        ...
        <x-container class="relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="grid grid-cols-1 gap-8 mt-16 md:grid-cols-3">
                    <div class="text-center">
                        <div class="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-white/10">
                            <i class="text-2xl text-green-300 fas fa-phone"></i>
                        </div>
                        <h3 class="mb-2 text-lg font-semibold">Llámanos</h3>
                        <p class="text-sm text-gray-300">Atención personalizada por teléfono</p>
                    </div>
                    <div class="text-center">
                        <div class="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-white/10">
                            <i class="text-2xl text-blue-300 fas fa-envelope"></i>
                        </div>
                        <h3 class="mb-2 text-lg font-semibold">Escríbenos</h3>
                        <p class="text-sm text-gray-300">Respuesta garantizada en 24h</p>
                    </div>
                    <div class="text-center">
                        <div class="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-white/10">
                            <i class="text-2xl text-purple-300 fas fa-comments"></i>
                        </div>
                        <h3 class="mb-2 text-lg font-semibold">Chat Online</h3>
                        <p class="text-sm text-gray-300">Soporte en tiempo real</p>
                    </div>
                </div>
            </div>
        </x-container>
